    ...
    <div className="intro">
      <div className="intro-left">
        <div className="intro-left-wrapper">
          ...
          <h1 className="intro-name">Duong</h1>
          <div className="intro-title">
            <div className="intro-title-wrapper">
              <div className="intro-title-item">Front developer</div>
              ...
              <div className="intro-title-item">Redux</div>
            </div>
          </div>
      ...
      <div className="intro-right">
        ...
        <img src={require("../../img/me.png")} alt="" className="intro-img" />
      </div>
    </div>
  );
};
